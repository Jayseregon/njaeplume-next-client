...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      className={cn(
        "flex h-9 w-full rounded-md border border-foreground bg-transparent px-3 py-2 text-sm shadow-xs transition-colors outline-none whitespace-nowrap justify-between gap-2 items-center",
        "focus-visible:outline-hidden focus-visible:ring-1 focus-visible:ring-neutral-950 disabled:cursor-not-allowed disabled:opacity-50",
        ...
        "aria-invalid:border-red-500 aria-invalid:ring-red-500/20 dark:aria-invalid:ring-red-900/20 dark:aria-invalid:border-red-900",
        className,
      )}
