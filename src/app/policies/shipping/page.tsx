          ...
          <div className="row">
            <div className="col-lg-8 offset-lg-2">
              ...
              <div className="mb-6 text-justify">
                ...
                <p className="mb-4">{t("policy.noShipping")}</p>
                <p className="mb-4">{t("policy.download")}</p>
                <p className="mb-4">{t("policy.technicalIssue")}</p>
                <p className="mb-4">{t("policy.understanding")}</p>
